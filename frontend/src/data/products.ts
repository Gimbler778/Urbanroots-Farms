...
function getProductImageUrls(searchTerm: string, seed: number): string[] {
  const iconPool = [
    'https://cdn-icons-png.flaticon.com/512/747/747376.png',
    'https://cdn-icons-png.flaticon.com/512/2292/2292039.png',
  ];

  const base = Math.abs(seed) % iconPool.length;
  return [
    iconPool[base],
    iconPool[(base + 1) % iconPool.length],
  ];
}
